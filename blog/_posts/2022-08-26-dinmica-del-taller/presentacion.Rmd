...
programa %>%
  ...
  add_indent( c(2:6, 8, 10, 12:14, 16:17, 19), level_of_indent = 1) %>%
  add_indent( c(7, 11, 18), level_of_indent = 2) %>%
  row_spec(c(1, 9, 15), bold = T, color = "gray50", background = "burlywood") %>%
  row_spec(c(7, 11, 18), bold = T, color = "green", background = "burlywood") %>%
